    ...
    <div className="flex-1 p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-100">MSFT</h1>
            <p className="text-gray-400 text-sm">Microsoft Corporation</p>
          </div>
          <div className="flex items-center space-x-3">
            <div className="text-xl font-bold text-gray-100">${currentPrice.close.toFixed(2)}</div>
        ...
        {[
          ...
          <Card key={stat.label} className="bg-gray-800/30 border-gray-700/50">
            <CardContent className="p-2">
              ...
              <div className={`text-sm font-semibold ${stat.color}`}>${stat.value.toFixed(2)}</div>
            </CardContent>
          </Card>
        ))}
      </div>
